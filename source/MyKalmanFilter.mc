...
// This Kalman filter is based on My Vario Lite by Yannick Dutertre and the implementation for Arduino Variometer
...
class MyKalmanFilter {
  ...
  private var p11 as Float = 0.0;
  private var p12 as Float = 0.0;
  private var p21 as Float = 0.0;
  private var p22 as Float = 0.0;

  // Position, velocity, acceleration, timestamp
  public var fPosition as Float = 0.0;
  public var fVelocity as Float = 0.0;
  public var fAcceleration as Float = 0.0;
  public var fTimestamp as Number = 0;
